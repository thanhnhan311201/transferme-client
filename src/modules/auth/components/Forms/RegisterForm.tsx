...
const RegisterForm: React.FC<{
	email: UseInputHook;
	username: UseInputHook;
	password: UseInputHook;
	confirmPassword: UseInputHook;
		...
		>
			...
			>
				<div className="mb-8 flex items-start justify-between">
					<div>
						<h2 className="mb-1 text-4xl font-bold">Sign up</h2>
				...
				<p className="text-center text-base">
					...
					<NavLink className="font-bold text-blue-500" to="/auth/signin">
						{' '}
						Sign in
					</NavLink>
				</p>
