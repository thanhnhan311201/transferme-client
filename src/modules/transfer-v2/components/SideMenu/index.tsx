		...
		<div className="fixed top-0 left-0 bottom-0 flex flex-col pt-[7.5rem] pb-[10.5rem] px-4 w-80 bg-main-bg">
			...
			<div className="grow flex flex-col items-start justify-start gap-4 w-full overflow-hidden">
				<div className="flex flex-col items-start justify-start w-full">
					<div className="rounded-lg shrink-0 h-12 w-full flex items-center gap-5 px-5 font-['Inter'] text-sm text-grey hover:text-white transition-colors font-semibold hover:shadow-[inset_0px_0.0625rem_0_rgba(255,255,255,0.05),0_0.25rem_0.5rem_0_rgba(0,0,0,0.1)] cursor-pointer">
				...
				<div className="grow flex flex-col items-start justify-start w-full overflow-hidden">
					<div className="shrink-0 w-full text-left px-5 py-4 font-['Inter'] text-sm text-grey/75">
						Transfer list
					</div>
					<div className="transfer-list grow flex flex-col justify-start gap-2 w-full h-full overflow-y-auto scroll-smooth">
						{userList.map((user) => (
							<button
								key={user.id}
								className={classNames(
									"rounded-lg w-full px-5 py-2 flex items-center gap-4 font-['Inter'] text-sm text-white--1/75 font-semibold transition-colors hover:text-white",
